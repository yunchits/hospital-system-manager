...
public class HospitalizationRepositoryImpl implements HospitalizationRepository {
    ...
    private static final String DELETE_HOSPITALIZATION_BY_PATIENT_ID_QUERY = "DELETE FROM hospitalization WHERE patient_id = ?";
    ...
    public Hospitalization create(Hospitalization hospitalization) {
        try (ReusableConnection connection = POOL.getConnection();
            ...
            statement.setLong(1, hospitalization.getPatientId());
    ...
    private Hospitalization resultSetToHospitalization(ResultSet resultSet) throws SQLException {
